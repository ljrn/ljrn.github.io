const trad={
  "french" : {
      ...
      "stat_pavement_text" : "Cette analyse a été faite pour aider la direction à prendre des décisions sur les travaux à effectuer.",
      "secure_novanet" : "Sécurisation d'une application Web contre les vulnérabilités XSS",
      "secure_novanet_text" : "Ce projet a été réalisé pour sécuriser Novanet, un logiciel d'Antenia, contre les vulnérabilités XSS.",
      "secure_chat" : "Chat en ligne sécurisé",
      "secure_chat_text" : "Création d'un chat Web sécurisé avec cryptage RSA et mots de passe SALT.",
      "video_games" : "Site web de recherche de jeux-vidéos",
      "video_games_text" : "Création d’un site Web de recherche de jeux vidéo avec le modèle simple page app (SPA) et la programmation par composants.",
  ...
  "english": {
    ...
    "stat_pavement_text": "This analysis was done to assist management in making decisions on the works to be performed.",
    "secure_novanet": "Securing a Web Application against XSS vulnerabilities",
    "secure_novanet_text": "This project was made to secure Novanet, an Antenia's software, against XSS vulnerabilities.",
    "secure_chat": "Secure Web Chat",
    "secure_chat_text": "Creating a secure Web Chat with RSA encryption and SALT passwords.",
    "video_games": "Video games website",
    "video_games_text": "Creating a video games Website with the Single Page App (SPA) Model and components programming.",
    "web_server": "Web Server",
    "web_server_text": "Creating a Web Server.",
    "M3d": "3D Modeling Software",
    "M3d_text": "This software has been created to transform .ply models into 3D models using JavaFX and MVC pattern. It has been developped in collaboration with three collegues named Baptiste Momut, Mohamed Bourdim and Mohnes Hamroun.",
    "about_me_text": "About me",
    "about_text": "Currently studying Software Engineering and Data Science at the University Polytechnical School of Lille (Polytech), I am also apprentice at the \"Département du Nord\" as a Software Engineer and Data Analyst. Before Polytech, I studied Software Development for 2 years at the University Institute of Technology of Lille. These 2 years have allowed me to discover software development and get my first diploma in this field.",
    "skills" : "My skills",
    "lang": "Languages",
    "french": "French",
    "english": "English",
  ...
  "spanish" : {
    ...
    "stat_pavement_text": "Este análisis se realizó para ayudar a la dirección en la toma de decisiones sobre las obras a realizar.",
    "secure_novanet": "Protección de una aplicación web contra vulnerabilidades XSS",
    "secure_novanet_text": "Este proyecto fue hecho para asegurar Novanet, un software de Antenia, contra vulnerabilidades XSS.",
    "secure_chat": "Secure Web Chat",
    "secure_chat_text": "Creación de un chat web seguro con cifrado RSA y contraseñas SALT.",
    "video_games": "Sitio web de videojuegos",
    "video_games_text": "Creación de un sitio web de videojuegos con el modelo single page app (SPA) y programación de componentes.",
    "web_server": "Servidor web",
    "web_server_text": "Creación de un servidor web.",
    "M3d": "3D Modeling Software",
    "M3d_text": "Este software ha sido creado para transformar modelos . ply en modelos 3D utilizando JavaFX y MVC patrón. Ha sido desarrollado en colaboración con tres colegas llamados Baptiste Momut, Mohamed Bourdim y Mohnes Hamroun.",
  ...
  "portuguese" : {
    ...
    "stat_pavement_text": "Esta análise foi realizada para ajudar a direção na tomada de decisões sobre as obras a serem realizadas.",
    "secure_novanet": "Proteção de uma aplicação web contra vulnerabilidades XSS",
    "secure_novanet_text": "Este projeto foi feito para garantir a Novanet, um software de Antenia, contra vulnerabilidades XSS.",
    "secure_chat": "Secure Web Chat",
    "secure_chat_text": "Criação de um chat web seguro com criptografia RSA e senhas SALT.",
    "video_games": "Sítio Web de jogos de vídeo",
    "video_games_text": "Criação de um site de videojogos com o modelo single page app (SPA) e programação de componentes.",
    "web_server": "Servidor web",
    "web_server_text": "Criação de un servidor web.",
    "M3d": "3D Modeling Software",
    "M3d_text": "Este software foi criado para transformar modelos . Ply em modelos 3D usando JavaFX e MVC padrão. Foi desenvolvido em colaboração com três colegas chamados Baptiste Momut, Mohamed Bourdim e Mohnes Hamroun.",
...
const changeLanguage = (language) => {
  ...
  document.querySelector('#stat-pavement').textContent=traduction.stat_pavement;
  document.querySelector('#stat-pavement-text').textContent=traduction.stat_pavement_text;
  document.querySelector('#secure-novanet').textContent=traduction.secure_novanet;
