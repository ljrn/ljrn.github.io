...
const trad = {
  "french": {
    ...
    "secure_novanet_text": "Ce projet a été réalisé pour sécuriser Novanet, un logiciel d'Antenia, contre les vulnérabilités XSS. Il s'appuie particulièrement les technologies en lien avec le HEADER des requêtes HTTP et l'analyse de ces requêtes.",
    ...
    "video_games_text": "Création d’un site Web de recherche de jeux vidéo avec le modèle simple page app (SPA) et la programmation par composants (Principe de REACT). La mise en page du site a été faite via l'API Materialize.",
  ...
  "english": {
    ...
    "secure_chat_text": "Creating a secure Web Chat with RSA encryption and SALT passwords. This site introduces relatively secure crytography concepts and shows their implementation in JAVA.",
  ...
  "spanish": {
    ...
    "secure_chat": "Secure Web Chat",
    "secure_chat_text": "Creación de un chat web seguro con cifrado RSA y contraseñas SALT. Este sitio presenta conceptos de criotografía relativamente seguros y muestra su implementación en JAVA.",
    ...
    "web_server_text": "Creación de un servidor web para la distribución de archivos en red.",
    "M3d": "3D Modeling Software",
  ...
  "portuguese": {
    ...
    "secure_chat": "Secure Web Chat",
    "secure_chat_text": "Criação de um chat web seguro com criptografia RSA e senhas SALT. Este site apresenta conceitos de criotografia relativamente seguros e mostra sua implementação em JAVA.",
    ...
    "web_server": "Servidor web",
    "web_server_text": "Criação de um servidor web para a distribuição de arquivos em rede.",
    "M3d": "3D Modeling Software",
