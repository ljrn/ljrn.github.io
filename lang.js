...
const trad = {
  "french": {
    ...
    "infineed" : "Infineed",
    "infineed_text" : "Cette application web progressive (PWA) a été créée lors de mon passage à l'Université de Neuchâtel. Elle a pour but de réduire la consommation énergétique des utilisateurs en les faisant discuter avec un Chatbot d'assitance. Nous avons paramétré l'API ChatGPT pour réaliser cette tâche.",
  ...
  "english": {
    ...
    "infineed" : "Infineed",
    "infineed_text": "This progressive web app (PWA) was created during my time at the University of Neuchâtel. It aims to reduce the energy consumption of users by making them discuss with a Chatbot. We have set up the ChatGPT API to perform this task.",
    "portfolio": "Portfolio",
  ...
  "spanish": {
    ...
    "infineed" : "Infineed",
    "infineed_text" : "Esta aplicación web progressiva (PWA) fue creada durante mi paso por la Universidad de Neuchâtel. Su objetivo es reducir el consumo de energía de los usuarios haciéndolos hablar con un Chatbot de asistencia. Hemos configurado la API ChatGPT para realizar esta tarea.",
    "portfolio": "Cartera",
  ...
  "portuguese": {
    ...
    "infineed" : "Infineed",
    "infineed_text" : "Este aplicativo web progressivo (PWA) foi criado durante minha passagem pela Universidade de Neuchâtel. Seu objetivo é reduzir o consumo de energia dos usuários fazendo-os conversar com um Chatbot de assistência. Configuramos a API ChatGPT para realizar essa tarefa.",
    "portfolio": "Carteira",
